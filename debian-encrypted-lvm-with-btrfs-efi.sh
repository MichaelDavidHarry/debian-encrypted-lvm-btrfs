...
EFI_BLOCK_DEVICE_UUID=`blkid -o value -s UUID "$EFI_BLOCK_DEVICE"`
...
EFI_BLOCK_DEVICE_UUID=\"$EFI_BLOCK_DEVICE_UUID\"
...
echo \"UUID=$EFI_BLOCK_DEVICE_UUID   /boot/efi   vfat   defaults   0   0\" >> /etc/fstab
